...
And here's the SQL generated by the Snaplet Data Client:
...
We intend to generate the Snaplet Data Client as a standalone tool that you will be able to use anywhere!